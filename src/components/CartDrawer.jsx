...
// };
  ...
  const generateInvoiceData = () => {
    return {
      orderId: "MS-" + user.uid + new Date().getTime(),
      username: userProfile.username,
      fullname: userProfile.fullname,
      email: userProfile.email,
      items: cart,
  ...
  // Function to handle generating invoice
  const handleGenerateInvoice = () => {
    const invoiceData = generateInvoiceData();
    // Navigate to the invoice page with invoiceData
    // You can use a routing library like React Router for this
    // Example:
    history.push('/invoice', invoiceData);
  };
